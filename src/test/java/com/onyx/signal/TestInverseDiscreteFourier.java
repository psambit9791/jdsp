...
public class TestInverseDiscreteFourier {
    ...
    public void testInverseFourierComplex() {
        double[] result = {0.0,  0.684,  1.192,  1.401,  1.281,  0.894,  0.373, -0.133, -0.504, -0.688, -0.702, -0.615,
        ...
        double[] out = transformer.ifft();
        assertArrayEquals(out, result, 0.001);
    }

    @Test
    public void testInverseFourierReal() {
        double[] result = {-0.0, 0.342, 0.254, 0.105, -0.06, -0.193, -0.261, -0.253, -0.186, -0.092, -0.007, 0.043,
